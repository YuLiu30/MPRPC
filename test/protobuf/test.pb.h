...
namespace fixbug {
class GEetFriendListsResponse;
class GEetFriendListsResponseDefaultTypeInternal;
extern GEetFriendListsResponseDefaultTypeInternal _GEetFriendListsResponse_default_instance_;
...
namespace google {
namespace protobuf {
template<> ::fixbug::GEetFriendListsResponse* Arena::CreateMaybeMessage<::fixbug::GEetFriendListsResponse>(Arena*);
...
class GEetFriendListsResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:fixbug.GEetFriendListsResponse) */ {
 public:
  GEetFriendListsResponse();
  virtual ~GEetFriendListsResponse();

  GEetFriendListsResponse(const GEetFriendListsResponse& from);

  inline GEetFriendListsResponse& operator=(const GEetFriendListsResponse& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  GEetFriendListsResponse(GEetFriendListsResponse&& from) noexcept
    : GEetFriendListsResponse() {
    *this = ::std::move(from);
  }

  inline GEetFriendListsResponse& operator=(GEetFriendListsResponse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const GEetFriendListsResponse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GEetFriendListsResponse* internal_default_instance() {
    return reinterpret_cast<const GEetFriendListsResponse*>(
               &_GEetFriendListsResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  void Swap(GEetFriendListsResponse* other);
  friend void swap(GEetFriendListsResponse& a, GEetFriendListsResponse& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline GEetFriendListsResponse* New() const final {
    return CreateMaybeMessage<GEetFriendListsResponse>(NULL);
  }

  GEetFriendListsResponse* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<GEetFriendListsResponse>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const GEetFriendListsResponse& from);
  void MergeFrom(const GEetFriendListsResponse& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GEetFriendListsResponse* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GEetFriendListsResponse)
 private:
...
// .fixbug.ResultCode result = 1;
inline bool GEetFriendListsResponse::has_result() const {
  return this != internal_default_instance() && result_ != NULL;
}
inline void GEetFriendListsResponse::clear_result() {
  if (GetArenaNoVirtual() == NULL && result_ != NULL) {
    delete result_;
  }
  result_ = NULL;
}
inline const ::fixbug::ResultCode& GEetFriendListsResponse::_internal_result() const {
  return *result_;
}
inline const ::fixbug::ResultCode& GEetFriendListsResponse::result() const {
  const ::fixbug::ResultCode* p = result_;
  // @@protoc_insertion_point(field_get:fixbug.GEetFriendListsResponse.result)
  return p != NULL ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline ::fixbug::ResultCode* GEetFriendListsResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GEetFriendListsResponse.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = NULL;
  return temp;
}
inline ::fixbug::ResultCode* GEetFriendListsResponse::mutable_result() {
  
  if (result_ == NULL) {
    auto* p = CreateMaybeMessage<::fixbug::ResultCode>(GetArenaNoVirtual());
    result_ = p;
  }
  // @@protoc_insertion_point(field_mutable:fixbug.GEetFriendListsResponse.result)
  return result_;
}
inline void GEetFriendListsResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GEetFriendListsResponse.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GEetFriendListsResponse::friend_list_size() const {
  return friend_list_.size();
}
inline void GEetFriendListsResponse::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GEetFriendListsResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GEetFriendListsResponse.friend_list)
  return friend_list_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::fixbug::User >*
GEetFriendListsResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GEetFriendListsResponse.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GEetFriendListsResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GEetFriendListsResponse.friend_list)
  return friend_list_.Get(index);
}
inline ::fixbug::User* GEetFriendListsResponse::add_friend_list() {
  // @@protoc_insertion_point(field_add:fixbug.GEetFriendListsResponse.friend_list)
  return friend_list_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::fixbug::User >&
GEetFriendListsResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GEetFriendListsResponse.friend_list)
  return friend_list_;
}
